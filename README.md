...
**Learn. Code. Build.**  
Welcome to **Ed-Tech-Club** – a beginner-friendly platform to learn HTML through engaging video tutorials, an interactive coding playground, and a personalized learning experience.

![image](https://github.com/user-attachments/assets/e0487466-9170-4e4a-90e8-b2d79c645fe4)

## 🚀 Features

- 🎥 **HTML Video Tutorials**  
  Learn the basics of HTML with clear, step-by-step video lessons.
  ![image](https://github.com/user-attachments/assets/a1e77bfa-dd64-475b-bb3e-18356d113bf1)
...
```bash
git clone https://github.com/AnkitGE001/Ed-Tech-Club.git
cd ed-tech-club
npm install
npm start
